...
// import { ReactComponent as ListBtn } from '../../assets/icons/list-btn.svg';
// import { ReactComponent as TileBtn } from '../../assets/icons/tile-btn.svg';
import './navigation.scss';

export const Navigation = () => {
  return (
    <div className='navigation'>
      <input type='text' className='navigation__search' placeholder='Поиск книги или автора…' />

      <select id='filter' className='navigation__filter' placeholder='По рейтингу'>
        <option value='rate'>По рейтингу</option>
        <option value='date'>По дате</option>
        <option value='price'>По цене</option>
      </select>
      {/* <input type='text' className='navigation__filter' placeholder='По рейтингу' /> */}

      <div className='navigation__display'>
        <button type='button' className='display-btn tile active'>
          <svg className='tile-btn' width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
        ...
        <button type='button' className='display-btn list'>
          <svg className='tile-btn' width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
