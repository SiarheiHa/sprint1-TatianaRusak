...
export const RulesPage = () => {
  return (
    <div className='rules'>
      ...
      <ol className='rules__list-1level'>
        <li className='rules__item-1level'>
          ...
          <ol className='rules__list-2level'>
            <li className='rules__item-2level'>
        ...
        <li className='rules__item-1level'>
          ...
          <ol className='rules__list-2level'>
            <li className='rules__item-2level'>
              ...
              участника как способного принимать собственные решения касаемо инновационных методов управления
              процессами.
              <ol className='rules__list-3level'>
                <li className='rules__item-3level'>
            ...
            <li className='rules__item-2level'>
              ...
              <ol className='list-3level'>
                <li className='rules__item-3level'>
                  ...
                  <ol className='rules__list-4level'>
                    <li className='rules__item-4level'>
